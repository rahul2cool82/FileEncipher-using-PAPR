...
public class Round13 {
	...
	public Round13(String Bin){
		...
		for(int i=0;i<32;i++){
			...
			temp1=str[i];
			char a=temp1.charAt(0),b,c=temp1.charAt(1),d,e=temp1.charAt(3),f;
			if(a=='0'){
				b='1';
			}
			else{
			...
			temp=String.valueOf(b)+String.valueOf(d)+temp1.substring(2, 3)+String.valueOf(f);
