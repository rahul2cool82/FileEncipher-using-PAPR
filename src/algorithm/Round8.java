...
public class Round8 {
	...
	public Round8(String Bin){
		...
		for(int i=0;i<32;i++){
			...
			temp1=str[i];
			char a=temp1.charAt(1),b,c=temp1.charAt(2),d;
			if(a=='0'){
				b='1';
			}
			else{
			...
			temp=temp1.substring(0, 1)+String.valueOf(b)+String.valueOf(d)+temp1.substring(3, temp1.length());
