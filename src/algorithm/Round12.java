...
public class Round12 {
	...
	public Round12(String Bin){
		...
		for(int i=0;i<32;i++){
			...
			temp1=str[i];
			char a=temp1.charAt(0),b,c=temp1.charAt(2),d,e=temp1.charAt(3),f;
			if(a=='0'){
				b='1';
			}
			else{
			...
			temp=String.valueOf(b)+temp1.substring(1, 2)+String.valueOf(d)+String.valueOf(f);
