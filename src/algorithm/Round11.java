...
public class Round11 {
	...
	public Round11(String Bin){
		...
		for(int i=0;i<32;i++){
			...
			temp1=str[i];
			char a=temp1.charAt(1),b,c=temp1.charAt(2),d,e=temp1.charAt(3),f;
			if(a=='0'){
				b='1';
			}
			else{
			...
			temp=temp1.substring(0, 1)+String.valueOf(b)+String.valueOf(d)+String.valueOf(f);
