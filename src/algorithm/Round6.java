...
public class Round6 {
	...
	public Round6(String Bin){
		...
		for(int i=0;i<32;i++){
			...
			temp1=str[i];
			char a=temp1.charAt(0),b,c=temp1.charAt(2),d;
			if(a=='0'){
				b='1';
			}
			else{
			...
			temp=String.valueOf(b)+temp1.substring(1, 2)+String.valueOf(d)+temp1.substring(3, temp1.length());
